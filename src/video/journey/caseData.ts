...
export const CASE = {
  ...
  alternatives: [
    ...
    {
      ar: "رسالة نصية مع خطاب تسوية",
      en: "SMS + Settlement Letter",
      fit: 0.89,
      ok: true,
  ...
  outcome: [
    ...
    { ar: "تم التفاعل", en: "Engaged", v: "فتح خطاب التسوية" },
  ...
  metrics: [
    ...
    { ar: "استلام الخطاب", en: "Letter Received", v: "نعم", p: 1 },
